...
public class InfoMenu implements EssentialsGuis {
    ...
    public InfoMenu() {
        ...
        EssentialsButton tutorialsButton = new EssentialsButton(1, tutorialsButtonAction);
    ...
    public void init(EntityPlayerMP player, EntityNPCInterface npc) {
        ...
        gui.addTexturedButton(2, "", 110, 48, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 32, 192);
        gui.addTexturedButton(3, "", 170, 48, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 128, 128);
