...
public class BagMenu implements EssentialsGuis {
    ...
    public BagMenu(){
        ...
        this.index=-1;
        this.addButton(new EssentialsButton(501, new ActionData("UPDATE_BAG", "ARMOURERS_WORKSHOP")));
        this.addButton(new EssentialsButton(502, new ActionData("UPDATE_BAG", "ITEMS")));
        this.addButton(new EssentialsButton(503, new ActionData("UPDATE_BAG", "KEY_ITEMS")));
        this.addButton(new EssentialsButton(504, new ActionData("UPDATE_BAG", "TM_HM")));
        this.addButton(new EssentialsButton(506, new ActionData("SCROLL", "-1")));
    }
    ...
    public void init(EntityPlayerMP player, EntityNPCInterface npc){
        ...
        if(this.getIndex()==-1) {
            ...
            if(this.category==EnumCategory.TM_HM){
                ...
                gui.addTexturedButton(505, "Teach", 0, 170, 128, 20, "obscureobsidian:textures/gui/arrow_select.png", 0, 0);
                gui.addTexturedButton(506, "Cancel", 0, 190, 128, 20, "obscureobsidian:textures/gui/arrow_select.png", 0, 0);
            }
        }
        gui.addTexturedButton(501, "", 0, 112, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 64, 64);
        gui.addTexturedButton(502, "", 32, 112, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 96, 64);
        gui.addTexturedButton(503, "", 64, 112, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 128, 64);
        gui.addTexturedButton(504, "", 96, 112, 32, 32, "obscureobsidian:textures/gui/oobuttons.png", 160, 64);
    ...
    public void update(EntityPlayerMP player){
        ...
        this.items=this.getItemNames(player);
        gui.removeComponent(505);
        gui.removeComponent(506);
        ...
        if(this.index!=-1) {
            ...
            if (this.category == EnumCategory.TM_HM) {
                ...
                if(this.isWearing(player)){
                    gui.addTexturedButton(505, "Remove", 0, 170, 128, 20, "obscureobsidian:textures/gui/arrow_select.png", 0, 0);
                }
                else {
                    gui.addTexturedButton(505, "Wear", 0, 170, 128, 20, "obscureobsidian:textures/gui/arrow_select.png", 0, 0);
                }
                gui.addTexturedButton(506, "Cancel", 0, 190, 128, 20, "obscureobsidian:textures/gui/arrow_select.png", 0, 0);
