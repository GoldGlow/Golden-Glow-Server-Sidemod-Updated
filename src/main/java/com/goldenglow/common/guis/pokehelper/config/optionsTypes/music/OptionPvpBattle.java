...
public class OptionPvpBattle implements OptionType {
    private String name="PvP Battle Theme";
    private ArrayList<SingleOptionData> options=new ArrayList<SingleOptionData>();
    File dir;

    public OptionPvpBattle(){
        dir = new File(Reference.settingsDir, "pvp_themes.json");
        if(!dir.exists()) {
