...
public class MusicConfig implements EssentialsGuis {
    ...
    public MusicConfig(){
        ...
        ActionData wildButtonAction=new ActionData("OPEN_OPTION", "WILD_THEME");
        this.addButton(new EssentialsButton(501, wildButtonAction));
        ActionData trainerButtonAction=new ActionData("OPEN_OPTION", "TRAINER_THEME");
        this.addButton(new EssentialsButton(502, trainerButtonAction));
        ActionData pvpThemeButtonAction=new ActionData("OPEN_OPTION", "PVP_THEME");
        this.addButton(new EssentialsButton(503, pvpThemeButtonAction));
        ActionData pvpSelectionButtonAction=new ActionData("OPEN_OPTION", "PVP_SELECTION");
