...
public class VisibilitySettings extends EssentialsGuiBase {
    ...
    public VisibilitySettings(){
        ...
        ActionData anyoneDmAction=new ActionStringData("SET_VIEW", "ANYONE");
        this.addButton(new EssentialsButton(501, new ActionData[]{anyoneDmAction, reloadAction}));
        ActionData friendsDmAction=new ActionStringData("SET_VIEW", "FRIENDS");
