...
public class OptionTrainerBattle implements OptionType {
    private String name="Trainer Battle Theme";
    private ArrayList<SingleOptionData> options=new ArrayList<SingleOptionData>();
    File dir;

    public OptionTrainerBattle(){
        dir = new File(Reference.settingsDir, "trainer_themes.json");
        if(!dir.exists()) {
