...
public class Route {
    ...
    public Route(String name, String display, String desc) {
        this.name = name;
        this.desc = desc;
        this.display = display;
    }

    public Route(String name, String desc, String display, Area area) {
        this.name = name;
        this.desc = desc;
        this.display= display;
        this.areas.add(area);
    ...
    public void playerCheck(World world) {
        for(Area area : areas) {
            ...
            for(Object obj : world.getEntitiesWithinAABB(EntityPlayerMP.class, new AxisAlignedBB(area.pos1.getX(), area.pos1.getY() - 5, area.pos1.getZ(), area.pos2.getX(), area.pos2.getY() + 5, area.pos2.getZ()))) {
